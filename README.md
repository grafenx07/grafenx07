...
# 👋 Hi, I'm Grafenberg Langpen

### 🚀 Full Stack Developer | AI/ML Enthusiast | Open Source Contributor

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/grafenberg-langpenn-20191a1a5/)
...
🎓 **Master of Computer Applications** | Kristu Jayanti College, Bengaluru  
📅 Aug. 2024 – Present

🎓 **Bachelor of Computer Applications** | St. Edmund's College, Shillong  
📅 Aug. 2021 – Jul. 2024
...
class Grafenberg:
    def __init__(self):
        ...
        self.location = "India"
        self.interests = ["Computer Vision", "Deep Learning", "Web Development"]
...
[![View Project](https://img.shields.io/badge/View_Code-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/grafenx07)

**Tech Stack:**  
`Python` `Flask` `FaceNet` `OpenCV` `MySQL` `HTML/CSS/JS`
...
**Tech Stack:**  
`Python` `YOLO` `OpenCV` `Twilio` `LabelImg` `Tkinter`

**Features:**
- 🎥 Real-time CCTV monitoring
- 🚑 Auto SMS alerts via Twilio
...
**Tech Stack:** `Python` `Custom Tkinter` `Speech Recognition` `OpenWeatherMap API`

**Features:**
- 🎤 Voice-activated commands | 🌐 Web search & Wikipedia integration | 🎵 Music player  
- 🌦️ Weather forecasts | 💬 Natural conversation | 🌍 Real-time translation
...
![Profile Views](https://komarev.com/ghpvc/?username=grafenx07&color=blueviolet&style=for-the-badge)
